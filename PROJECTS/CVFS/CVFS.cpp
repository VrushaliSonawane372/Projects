...
void man(char *name)
{
    ...
    {
        printf("Description : Used to read data regular file\n");
    ...
    else if(strcmp(name, "Iseek") == 0) 
    {
        ...
        printf("Usage : Iseek File_Name ChangelnOffset StartPoint\n");
    }
...
void DisplayHelp()
{
    ...
    printf("read  : To Read the contents fro  file\n");
...
int CreateFile(char *name,int permission)       //Demo.txt   3(r+w)
{
    int i= 0;
    PINODE temp = head;
